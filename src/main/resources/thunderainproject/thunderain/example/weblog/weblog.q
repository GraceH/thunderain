...
CREATE TABLE item_view_tachyon(time BIGINT, category STRING, item BIGINT, count BIGINT)
ROW FORMAT SERDE "shark.memstore2.ColumnarSerDe"
TBLPROPERTIES ("shark.cache" = "tachyon");

CREATE TABLE subcategory_view_tachyon(time BIGINT, category STRING, item BIGINT, count BIGINT)
ROW FORMAT SERDE "shark.memstore2.ColumnarSerDe"
TBLPROPERTIES ("shark.cache" = "tachyon");
